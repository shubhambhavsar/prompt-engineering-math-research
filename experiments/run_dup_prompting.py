#!/usr/bin/env python3
"""
DUP (Deeply Understanding the Problems) Experiment Runner

This script evaluates the DUP prompting technique on GSM8K.
Paper: https://arxiv.org/pdf/2404.14963
"""
...
from prompts.dup_prompting import DUPPrompt
from systems.multi_step_system import MultiStepSystem
...
def run_experiment(
    ...
    """
    Run DUP experiment on GSM8K examples.
    ...
    print("=" * 70)
    print("DUP (Deeply Understanding the Problems) Evaluation")
    print("=" * 70)
    print(f"Model                     : {model}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate DUP (Deeply Understanding the Problems) on GSM8K"
    )
