#!/usr/bin/env python3
"""
Plan-and-Solve Plus Experiment Runner

This script evaluates the Plan-and-Solve Plus prompting technique on GSM8K.
"""
...
from prompts.plan_solve_plus import PlanSolvePlusPrompt
...
def run_experiment(
    ...
    """
    Run Plan-and-Solve Plus experiment on GSM8K examples.
    ...
    print("=" * 70)
    print("Plan-and-Solve Plus Evaluation")
    print("=" * 70)
    print(f"Model                     : {model}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate Plan-and-Solve Plus on GSM8K"
    )
