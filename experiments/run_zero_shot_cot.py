#!/usr/bin/env python3
"""
Zero-Shot Chain-of-Thought Experiment Runner

This script evaluates the Zero-Shot CoT prompting technique on GSM8K.
"""
...
from prompts.zero_shot_cot import ZeroShotCoTPrompt
...
def run_experiment(
    ...
    """
    Run Zero-Shot CoT experiment on GSM8K examples.
    ...
    print("=" * 70)
    print("Zero-Shot Chain-of-Thought Evaluation")
    print("=" * 70)
    print(f"Model                     : {model}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate Zero-Shot Chain-of-Thought on GSM8K"
    )
